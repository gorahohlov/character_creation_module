"""RPC-game main module for terminal.
Author: Timur.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Calculate and display character's damage function."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate and display character's damage defence function."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Character's special skills function."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Characters introductions. Gamers brief instructions."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choise characters. Characters descriptions."""
